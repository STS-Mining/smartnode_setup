...
COIN_PORT="6678"
RPC_PORT="8484"
COIN_ZIP="babacoin-ubuntu20-1.0.0-SNAPSHOT.zip"
COIN_TAR="babacoin-ubuntu20-1.0.0-SNAPSHOT.tar.gz"
COIN_URL="https://github.com/babacoinbbc/babacoin/releases/download/v.1.0.0/${COIN_ZIP}"
BOOTSTRAP_URL="https://github.com/babacoinbbc/babacoin/releases/download/v.1.0.0/bootstrap.zip"
